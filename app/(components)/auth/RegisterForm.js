...
const RegisterForm = () => {
  ...
  //     }
  //   } catch (error) {
  //     if (error.code === "EDNS" && error.hostname === "smtp.gmail.com") {
  //       setError(
  //         "Error sending email: SMTP server not found. Please try again later."
  //       );
  //     } else {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-80 bg-white p-8 pt-2 rounded shadow-md flex flex-col h-[94vh]">
          {isSubmitting && <Loader />}
          ...
          {error && (
            <div className=" bg-red-500  text-white font-bold px-2 py-1 text-sm my-2 ">
              {error}
            </div>
          )}
        </div>
